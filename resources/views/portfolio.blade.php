...
<body id="page-top" class="politics_version">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('')">
		<div class="heading">
			...
			<h3 class="cd-headline clip is-full-width">
				...
				<span class="cd-words-wrapper">
					<b class="is-visible">Network Engineer</b>
                    <b>Cloud Engineer</b>
					<b>Web Design</b>
					<b>Web Developer</b>
				</span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">                        
                        <h2>About Me.</h2>
                        <p>
                        I am Jack, a passionate IT professional with a strong background in Network Engineering, Cloud Infrastructure, 
                        and Web Development. I have hands-on experience in designing, implementing, and maintaining reliable network 
                        systems, as well as deploying scalable cloud-based solutions to support modern business needs.
                        </p>
                        <p>
                        With a strong interest in technology and continuous learning, I focus on building secure, efficient, and 
                        user-friendly digital solutions. I enjoy working on web-based applications, server management, and cloud 
                        automation while ensuring performance, security, and reliability in every project I handle.
                        </p>
                        </p>

                       <a href="{{ url('/download-cv') }}"class="sim-btn btn-hover-new" data-text="Download CV"><span>Download CV</span></a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
    ...
    <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-left">
                <h3>Services</h3>
                <p>Providing reliable IT solutions, modern web development, and secure digital infrastructure for individuals and businesses.</p>
            ...
            <div class="row">
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>Network setup, configuration, monitoring, and troubleshooting to ensure secure, stable, and efficient connectivity for business environments.</p>
					</div>
                </div><!-- end col -->
                <div class="col-md-4">
                    <div class="services-inner-box">
                        ...
                        <p>Deployment and management of cloud-based infrastructure, including server configuration, scalability, backup, and performance optimization.</p>
					</div>
                </div><!-- end col -->
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>Creating user-friendly and responsive interfaces that adapt seamlessly across desktop, tablet, and mobile devices for the best user experience.</p>
					</div>
                </div><!-- end col -->
				<div class="col-md-4">
                    <div class="services-inner-box">
                        ...
                        <p>Providing technical support, system maintenance, and troubleshooting to keep IT systems running smoothly and securely.</p>
					</div>
                </div><!-- end col -->
				<div class="col-md-4">
                    <div class="services-inner-box">
					  ...
					  <p>Design and development of responsive, secure, and scalable web applications using modern technologies to support business operations and digital presence.</p>
					</div>
                </div><!-- end col -->
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<h2>IT Consulting</h2>
                        <p>Technology consultation to help businesses choose the right IT solutions, improve infrastructure, and optimize digital workflows.</p>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
	...
	<div id="portfolio" class="section lb">
		<div class="container">
			<div class="section-title text-left">
                <h3>Portfolio</h3>
                <p>Feel free to get in touch with me for collaboration, project inquiries, or any IT-related services. I am always open to discussing new ideas and opportunities.</p>
            </div><!-- end title -->
	...
	<div id="blog" class="section lb">
		<div class="container">
			<div class="section-title text-left">
                <h3>Blog</h3>
                <p>Sharing insights, tutorials, and experiences about networking, cloud computing, and web development.</p>
            </div><!-- end title -->
                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<input class="form-control" id="phone" type="text" inputmode="numeric" pattern="[0-9]+" placeholder="Your Phone"  oninvalid="this.setCustomValidity('Phone number must contain only numbers')"   oninput="this.setCustomValidity(''); this.value = this.value.replace(/[^0-9]/g, '')">
										<p class="help-block text-danger"></p>
									</div>
								</div>
								<div class="col-md-6">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    ...
                    <p class="footer-company-name">All Rights Reserved. &copy; 2025 <a href="#">Jack</a> Design By : 
					<a href="https://github.com/fatazakie/" target="_blank" rel="noopener noreferrer" >M. Fata Zhakie</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
